...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm"  method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="谷歌推广">
				<input type="hidden" name="activityId" value="04ff51f2ba8d4eb7ae5e8b2b62c8098b">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="狗蛋">
				<input type="hidden" name="contactsId" value="709869802e214a358bc1d3eac8308aa7">
